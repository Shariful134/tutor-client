...
//   const [tutor, setTutor] = useState<IStudent | undefined>(undefined);
//   const [studentId, setStudentId] = useState("");
//   const { user } = useUser();
//   const [loading, setLoading] = useState<boolean>(true);
//   const [time, setTime] = useState(0);
//   const [totalPrice, setTotalPrice] = useState(0);
//   // const tutor = getAllTutors();
...
//       try {
//         setLoading(true);
//         // const studentData = await Promise.all ([getAllStudent(),getAllTutors()]);
//         const [tutorData, studentData] = await Promise.all([
//           getAllTutors(),
//           getAllStudent(),
//         ]);
//         const foundStudent = studentData?.data?.filter(
//           (student: IStudent) => student.email === user?.userEmail
//         );
//         const foundTutor = tutorData?.data?.filter(
//           (tutor: IStudent) => tutor._id === tutorId
//         );
...
//   useEffect(() => {
//     calculatedPrice = Number(tutor?.hourlyRate) * time;
